...
public class UnknownDialogFagment extends DialogFragment implements View.OnClickListener {

    public static UnknownDialogFagment newInstance() {
        UnknownDialogFagment fragment = new UnknownDialogFagment();
        return fragment;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_unknown_speaker_dialog, null);
