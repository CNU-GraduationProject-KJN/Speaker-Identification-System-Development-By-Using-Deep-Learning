...
public class OKMsgDialogFragment extends DialogFragment implements View.OnClickListener {


    public static OKMsgDialogFragment newInstance() {
        OKMsgDialogFragment fragment = new OKMsgDialogFragment();
        return fragment;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_ok_msg_dialog, null);
